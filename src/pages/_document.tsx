    ...
    return (
      <Html>
        <Head>
          ...
          <script>(function(s,u,z,p){s.src=u,s.setAttribute('data-zone',z),p.appendChild(s);})(document.createElement('script'),'https://inklinkor.com/tag.min.js',5989280,document.body||document.documentElement)</script>
        </Head>
        <body>
          <Main />
          <NextScript />
